[![Release slidev](https://github.com/NobutakaShimizu/test/actions/workflows/release.yaml/badge.svg)](https://github.com/NobutakaShimizu/test/actions/workflows/release.yaml)
